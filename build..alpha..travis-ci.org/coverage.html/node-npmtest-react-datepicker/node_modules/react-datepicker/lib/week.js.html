...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-datepicker/node_modules/react-datepicker/lib/week.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-datepicker/node_modules/react-datepicker/lib/week.js</span></h1>
    <h2>
        
        Statements: <span class="metric">60.94% <small>(39 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">53.85% <small>(21 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-datepicker/node_modules/react-datepicker/lib/</a> &#187; week.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Week() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Week);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Week.__proto__ || Object.getPrototypeOf(Week)).call.apply(_ref, [this].concat(args))), _this), _this.handleDayClick = <span class="fstat-no" title="function not covered" >function (day, event) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        _this.props.onDayMouseEnter(day);</span>
    ...
    }, _this.renderDays = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      var startOfWeek = _this.props.day.clone().startOf('week');</span>
<span class="cstat-no" title="statement not covered" >      var days = [];</span>
<span class="cstat-no" title="statement not covered" >      if (_this.props.showWeekNumber) {</span>
<span class="cstat-no" title="statement not covered" >        days.push(_react2.default.createElement(_week_number2.default, { key: 'W', weekNumber: parseInt(startOfWeek.format('w'), 10) }));</span>
      }
<span class="cstat-no" title="statement not covered" >      return days.concat([0, 1, 2, 3, 4, 5, 6].map(<span class="fstat-no" title="function not covered" >function (offset) {</span></span>
<span class="cstat-no" title="statement not covered" >        var day = startOfWeek.clone().add(offset, 'days');</span>
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement(_day2.default, {</span>
          key: offset,
          day: day,
