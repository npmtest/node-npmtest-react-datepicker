...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-datepicker/node_modules/react-datepicker/lib/year_dropdown_options.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-datepicker/node_modules/react-datepicker/lib/year_dropdown_options.js</span></h1>
    <h2>
        
        Statements: <span class="metric">51.35% <small>(38 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-datepicker/node_modules/react-datepicker/lib/</a> &#187; year_dropdown_options.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function generateYears(year, noOfYear) {</span>
<span class="cstat-no" title="statement not covered" >  var list = [];</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0; i &lt; 2 * noOfYear; i++) {</span>
<span class="cstat-no" title="statement not covered" >    list.push(year + noOfYear - i);</span>
  }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function YearDropdownOptions(props) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, YearDropdownOptions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (YearDropdownOptions.__proto__ || Object.getPrototypeOf(YearDropdownOptions)).call(this, props));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.renderOptions = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      var selectedYear = _this.props.year;</span>
<span class="cstat-no" title="statement not covered" >      var options = _this.state.yearsList.map(<span class="fstat-no" title="function not covered" >function (year) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      options.unshift(_react2.default.createElement(</span>
        'div',
        { className: 'react-datepicker__year-option',
          ref: 'upcoming',
          key: 'upcoming',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.onChange = <span class="fstat-no" title="function not covered" >function (year) {</span></span>
<span class="cstat-no" title="statement not covered" >      _this.props.onChange(year);</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.handleClickOutside = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      _this.props.onCancel();</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.shiftYears = <span class="fstat-no" title="function not covered" >function (amount) {</span></span>
<span class="cstat-no" title="statement not covered" >      var years = _this.state.yearsList.map(<span class="fstat-no" title="function not covered" >function (year) {</span></span>
<span class="cstat-no" title="statement not covered" >        return year + amount;</span>
      });
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.incrementYears = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this.shiftYears(1);</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.decrementYears = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this.shiftYears(-1);</span>
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var dropdownClass = (0, _classnames2.default)({</span>
